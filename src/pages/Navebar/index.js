                    ...
                    <Menu theme="light" defaultSelectedKeys={['0']} mode="inline">
                        ...
                        >
                            <Menu.Item key="3" >
                                ...
                                <Link to='/selectlotes' onClick={this.onCollapse}>  Lotes </Link></Menu.Item>

                            <Menu.Item key="4">
                                <WalletOutlined theme="twoTone" style={{ paddingRight: '20px', fontSize: '22px', color: 'black' }} />
                                <Link to='/selectproprietarios'> Proprietários </Link></Menu.Item>
                        ...
                        <SubMenu
                            ...
                            title={
                                <span>
                                    ...
                                    <span style={{ paddingLeft: '10px' }}> Financeiro </span>
                                </span>
                            }
                        >
                            ...
                            <Menu.Item key="9">
                                ...
                                <Link to='/selectPagarMeta'> Emissão de Boletos </Link></Menu.Item>

                            <Menu.Item key="10">
                                <CreditCardOutlined theme="twoTone" style={{ paddingRight: '20px', fontSize: '22px', color: 'red' }} />
                                <Link to='/SelectFaturaContabilizada'> Relatórios </Link></Menu.Item>
                            {/* 
                            <Menu.Item key="11">
